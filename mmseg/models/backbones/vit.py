...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_width_size=224, img_heigh_size=224, patch_size=16, in_chans=3, embed_dim=768):
        super().__init__()
        #img_size = to_2tuple(img_size)
        img_size = to_2tuple1(img_width_size, img_heigh_size)
...
class HybridEmbed(nn.Module):
    ...
    def __init__(self, backbone, img_size=224, feature_size=None, in_chans=3, embed_dim=768):
        ...
        if feature_size is None:
            ...
            feature_size = to_2tuple1(480, 854)
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size = 334, patch_size=16, in_chans=3, embed_dim=1024, depth=24,
        ...
        img_width_size = 480
        img_heigh_size = 854
        self.img_width_size = img_width_size
        self.img_heigh_size = img_heigh_size
        self.patch_size = patch_size
        ...
        if self.hybrid_backbone is not None:
            ...
            self.patch_embed = PatchEmbed(
                img_width_size=self.img_width_size, img_heigh_size=self.img_heigh_size, patch_size=self.patch_size, in_chans=self.in_chans, embed_dim=self.embed_dim)
